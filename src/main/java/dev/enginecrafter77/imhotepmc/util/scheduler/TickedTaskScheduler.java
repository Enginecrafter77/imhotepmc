...
public class TickedTaskScheduler implements ITickable {
	private static final Logger LOGGER = LogManager.getLogger(TickedTaskScheduler.class);

	private final List<EnqueuedTickedTask<?>> tasks;

	public TickedTaskScheduler()
	{
